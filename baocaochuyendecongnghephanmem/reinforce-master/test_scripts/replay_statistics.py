...
test_commands = [train_cmd % (main_loc, test_games, mem_size, sample_size, i, mem_size, sample_size, i,
                              mem_size, sample_size) for mem_size in memories for sample_size in samples for i in range(1, runs+1)]
