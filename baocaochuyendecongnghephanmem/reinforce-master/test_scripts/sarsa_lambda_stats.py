...
print "TRAINING..."
train_commands = [train_cmd % (main_loc, train_games, l, t, i, l, t, i, l, t)
                  for l in lambdas for t in thresholds for i in range(1, runs+1)]
...
test_commands = [train_cmd % (main_loc, test_games, l, t, i, l, t, i, l, t)
                 for l in lambdas for t in thresholds for i in range(1, runs+1)]
